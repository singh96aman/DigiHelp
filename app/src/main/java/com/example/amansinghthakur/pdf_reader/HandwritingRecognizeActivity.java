...
public class HandwritingRecognizeActivity extends ActionBarActivity {
    ...
    private Button buttonSelectImage, b2;
    ...
    public void selectImage(View view) {
        ...
        Intent intent;
        intent = new Intent(HandwritingRecognizeActivity.this, com.example.amansinghthakur.pdf_reader.helper.SelectImageActivity.class);
            ...
            case REQUEST_SELECT_IMAGE:
                if (resultCode == RESULT_OK) {
                    ...
                    if (bitmap != null) {
                        ...
                        APIURLS.im.add(BitMapToString(bitmap));
    ...
    private static class doRequest extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String data) {
            ...
            if (e != null) {
                ...
                APIURLS.arr.add((resultBuilder.toString()));
            }
