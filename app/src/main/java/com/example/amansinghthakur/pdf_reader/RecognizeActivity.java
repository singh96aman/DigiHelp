...
public class RecognizeActivity extends ActionBarActivity {
    ...
    public void selectImage(View view) {
        ...
        Intent intent;
        intent = new Intent(RecognizeActivity.this, com.example.amansinghthakur.pdf_reader.helper.SelectImageActivity.class);
    ...
    private class doRequest extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String data) {
            ...
            if (e != null) {
                ...
                APIURLS.arr.add((result));
                //Log.e("debugaman",arr.toString());
            }
